...
#question 4 there is no more loop as qustion 3 was the nice one so will qustion 6 have a loop
...
#looping again as it is question 6
correct = False
while not correct:
...
if question_one ==(answers[7]): 
  print("LETS GOOOO!!!!!")
  user_points +=2
elif question_8 !=(answers[7]):
